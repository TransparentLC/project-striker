...
void xbrz_scale(size_t factor, const uint32_t* src, uint32_t* trg, int srcWidth, int srcHeight, xbrz::ColorFormat colFmt) {
    xbrz::scale(factor, src, trg, srcWidth, srcHeight, colFmt, xbrz::ScalerCfg(), 0, std::numeric_limits<int>::max());
};
